    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if (cookies != null){
            for(Cookie cookie: cookies){
                if("contadorVisitas".equals(cookie.getName())){
        ...
        // Creamos una nueva cookie con el valor del contador actualizado
        Cookie cookie = new Cookie("contadorVisitas", Integer.toString(contador));
        cookie.setMaxAge(3600);// La cookie durara 1 hora
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Numero de visitas: " + contador + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
